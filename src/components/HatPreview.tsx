  ...
  switch (hatId) {
    case 'crown':
      return (
        <svg width={width} height={height} viewBox="0 0 100 80" fill="none">
          ...
          <rect x="8" y="65" width="84" height="10" fill={`url(#crownGold-${hatId})`} stroke="#B8860B" strokeWidth="1" />
        </svg>
      );
    ...
    case 'party':
      return (
        <svg width={width} height={height} viewBox="0 0 100 80" fill="none">
          <defs>
            <linearGradient id={`partyGradient-${hatId}`} x1="0%" y1="0%" x2="100%" y2="0%">
    ...
    case 'wizard':
      return (
        <svg width={width} height={height} viewBox="0 0 100 90" fill="none">
          <defs>
            <linearGradient id={`wizardGradient-${hatId}`} x1="0%" y1="0%" x2="0%" y2="100%">
    ...
    case 'cowboy':
      return (
        <svg width={width} height={height} viewBox="0 0 120 80" fill="none">
          <defs>
            <linearGradient id={`cowboyGradient-${hatId}`} x1="0%" y1="0%" x2="0%" y2="100%">
              <stop offset="0%" stopColor="#D2691E" />
              <stop offset="100%" stopColor="#8B4513" />
            </linearGradient>
          </defs>
          <ellipse cx="60" cy="65" rx="58" ry="12" fill={`url(#cowboyGradient-${hatId})`} stroke="#5D3A1A" strokeWidth="2" />
          <path 
            d="M25 65 Q25 30 60 25 Q95 30 95 65" 
            fill={`url(#cowboyGradient-${hatId})`}
            stroke="#5D3A1A"
            strokeWidth="2"
          />
    ...
    case 'chef':
      return (
        <svg width={width} height={height} viewBox="0 0 100 80" fill="none">
          <defs>
            <linearGradient id={`chefGradient-${hatId}`} x1="0%" y1="0%" x2="0%" y2="100%">
              <stop offset="0%" stopColor="#FFFFFF" />
              <stop offset="100%" stopColor="#E8E8E8" />
            </linearGradient>
          </defs>
          <circle cx="50" cy="20" r="18" fill={`url(#chefGradient-${hatId})`} stroke="#CCC" strokeWidth="1" />
          <circle cx="30" cy="28" r="15" fill={`url(#chefGradient-${hatId})`} stroke="#CCC" strokeWidth="1" />
          <circle cx="70" cy="28" r="15" fill={`url(#chefGradient-${hatId})`} stroke="#CCC" strokeWidth="1" />
          <circle cx="25" cy="45" r="12" fill={`url(#chefGradient-${hatId})`} stroke="#CCC" strokeWidth="1" />
          <circle cx="75" cy="45" r="12" fill={`url(#chefGradient-${hatId})`} stroke="#CCC" strokeWidth="1" />
          <rect x="20" y="55" width="60" height="15" rx="2" fill={`url(#chefGradient-${hatId})`} stroke="#CCC" strokeWidth="1" />
        </svg>
      );
    ...
    case 'astronaut':
      return (
        <svg width={width} height={height * 1.2} viewBox="0 0 100 100" fill="none">
          <defs>
            <linearGradient id={`helmetGradient-${hatId}`} x1="0%" y1="0%" x2="0%" y2="100%">
              <stop offset="0%" stopColor="#F5F5F5" />
              <stop offset="100%" stopColor="#A0A0A0" />
            </linearGradient>
            <linearGradient id={`visorGradient-${hatId}`} x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="#FFD700" stopOpacity="0.8" />
              <stop offset="50%" stopColor="#FFA500" stopOpacity="0.6" />
              <stop offset="100%" stopColor="#FF8C00" stopOpacity="0.8" />
            </linearGradient>
          </defs>
          <ellipse cx="50" cy="55" rx="45" ry="40" fill={`url(#helmetGradient-${hatId})`} stroke="#666" strokeWidth="3" />
          <ellipse cx="50" cy="58" rx="32" ry="28" fill={`url(#visorGradient-${hatId})`} stroke="#333" strokeWidth="2" />
    ...
    case 'pirate':
      return (
        <svg width={width} height={height} viewBox="0 0 100 80" fill="none">
          <defs>
            <linearGradient id={`pirateGradient-${hatId}`} x1="0%" y1="0%" x2="0%" y2="100%">
    ...
    case 'princess':
      return (
        <svg width={width} height={height * 0.6} viewBox="0 0 100 50" fill="none">
          <defs>
            <linearGradient id={`tiaraGradient-${hatId}`} x1="0%" y1="0%" x2="0%" y2="100%">
    ...
    case 'unicorn-horn':
      return (
        <svg width={width * 0.6} height={height * 1.2} viewBox="0 0 60 100" fill="none">
          <defs>
            <linearGradient id={`hornGradient-${hatId}`} x1="0%" y1="100%" x2="0%" y2="0%">
    ...
    case 'dragon-horns':
      return (
        <svg width={width} height={height} viewBox="0 0 120 80" fill="none">
          <defs>
            <linearGradient id={`dragonHornGradient-${hatId}`} x1="0%" y1="100%" x2="0%" y2="0%">
          ...
          <path 
            ...
            fill={`url(#dragonHornGradient-${hatId})`}
            stroke="#1a1a1a"
            strokeWidth="2"
          />
          <path 
    ...
    default:
      return (
        <svg width={width} height={height} viewBox="0 0 100 80" fill="none">
          <defs>
            <linearGradient id={`defaultHatGradient-${hatId}`} x1="0%" y1="0%" x2="0%" y2="100%">
              <stop offset="0%" stopColor="#333" />
              <stop offset="100%" stopColor="#111" />
            </linearGradient>
          </defs>
          <ellipse cx="50" cy="65" rx="45" ry="10" fill={`url(#defaultHatGradient-${hatId})`} stroke="#000" strokeWidth="2" />
          <path 
            d="M25 65 Q25 30 50 25 Q75 30 75 65" 
            fill={`url(#defaultHatGradient-${hatId})`}
            stroke="#000"
            strokeWidth="2"
          />
